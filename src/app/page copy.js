  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col items-center justify-center">
        <div className='grid grid-cols-3 h-screen gap-8 p-6 max-w-7xl mx-auto'>
          <label htmlFor="my-drawer-2" className=" fixed top-6 right-6 btn btn-primary drawer-button lg:hidden">Open drawer</label>
        ...
        {/* Page content here */}
        <label htmlFor="my-drawer-2" className="z-50 absolute top-6 left-0 btn btn-primary drawer-button">Open drawer</label>
      </div>
